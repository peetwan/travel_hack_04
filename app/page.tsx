...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-1 flex-col">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-1 flex-col items-center gap-10 px-6 pb-20 pt-10 text-center sm:gap-12 sm:pt-14">
        ...
        <section className="w-full max-w-3xl">
          ...
          <div className="mt-5 grid grid-cols-1 gap-2 text-left sm:grid-cols-2 lg:grid-cols-4">
            {EXAMPLES.map((ex) => (
              <button
                key={ex.label}
                type="button"
