#!/usr/bin/env python3
"""Validate one TAT enrichment by lat/lng distance to our wellness venue."""
# coding: utf-8
import json
import math
import sys
...
if not venue or not detail or detail.get("statusCode"):
...
R = 6371
d_lat = math.radians(lat - venue["lat"])
d_lng = math.radians(lng - venue["lng"])
a = (
    math.sin(d_lat / 2) ** 2
    + math.cos(math.radians(venue["lat"]))
